 ...
 */
jint Java_com_myandb_singsong_libogg_VorbisFileOutputStream_create(
        JNIEnv* env,
        jobject this,
        jstring path,
        jobject info
 ...
 *
 */
jint Java_com_myandb_singsong_libogg_VorbisFileOutputStream_writeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx,
        jshortArray pcm,
 ...
 */
void Java_com_myandb_singsong_libogg_VorbisFileOutputStream_closeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx
        )
