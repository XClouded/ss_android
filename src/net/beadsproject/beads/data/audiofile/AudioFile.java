 ...
 * however if you want to use it, then {@link AudioIO.getAudioFile} will return
 * an audio file.
 * 
...
public abstract class AudioFile {
	 ...
	 * For some audio formats, this may involve re-opening the associated file.
	 */
	public abstract void skip(long frames) throws IOException;
	 ...
	 */
	public abstract void seek(int frame) throws IOException;
	 ...
	 */
	public abstract int read(float[][] buffer) throws IOException;
	 ...
	 * @return
	 */
	public abstract int write(float[] buffer) throws IOException;
	public abstract int write(float[][] buffer) throws IOException;
