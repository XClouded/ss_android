...
public class SelectRecordModeDialog extends BaseDialog {
	...
	protected void setupViews() {
		if (music != null) {
			...
			btnSingAlone.setOnClickListener(singAloneClickListener);
			btnSingDuet.setOnClickListener(singDuetClickListner);
	...
	private OnClickListener singAloneClickListener = new OnClickListener() {
	...
	private OnClickListener singDuetClickListner = new OnClickListener() {
